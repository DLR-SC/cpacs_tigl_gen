...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const CPACSDerived& GetA() const;
        TIGL_EXPORT virtual CPACSDerived& GetA();
...
namespace generated
{
    ...
    const CPACSDerived& CPACSRoot::GetA() const
    {
        return m_a;
    }

    CPACSDerived& CPACSRoot::GetA()
    {
        return m_a;
    }
